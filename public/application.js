...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fileEvents = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://murmuring-plains-65734.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fileApi = __webpack_require__(14);
	var fileUi = __webpack_require__(15);
	var store = __webpack_require__(11);

	// File events
	var onIndexFolder = function onIndexFolder() {
	  // event.preventDefault()
	  // const data = getFormFields(event.target)
	  fileApi.folderIndex().then(fileUi.folderIndexSuccess).catch(fileUi.folderIndexFailure);
	};

	var onIndexFile = function onIndexFile() {
	  // event.preventDefault()
	  // const data = getFormFields(event.target)
	  fileApi.fileIndex().then(fileUi.indexFileSuccess).catch(fileUi.indexFileFailure);
	};

	var onAddFile = function onAddFile(event) {
	  event.preventDefault();
	  var data = new FormData(event.target);
	  // for (let pair of data.entries()) {
	  //   console.log(pair[0], pair[1], pair[2])
	  // }
	  fileApi.addFile(data).then(fileUi.addFileSuccess).catch(fileUi.addFileFailure);
	};

	var onUpdateFile = function onUpdateFile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  fileApi.updateFile(data).then(fileUi.updateFileSuccess).catch(fileUi.updateFileFailure);
	};

	var onDeleteFile = function onDeleteFile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  fileApi.deleteFile(data).then(fileUi.deleteFileSuccess).catch(fileUi.deleteFileFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// FILE ACTIONS
	var folderIndex = function folderIndex() {
	  return $.ajax({
	...
	var fileIndex = function fileIndex(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/files',
	    method: 'GET',
	    headers: {
	...
	var addFile = function addFile(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/files',
	    method: 'POST',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// File UI events
	var foldersTemplate = __webpack_require__(18);
	var filesTemplate = __webpack_require__(38);

	var reloadFileList = function reloadFileList() {
	  fileApi.fileIndex().then(fileIndexSuccess).catch(fileIndexFailure);
	};

	var reloadFolderList = function reloadFolderList() {
	  fileApi.fileIndex().then(folderIndexSuccess).catch(folderIndexFailure);
	};

	// folder index

	var filterByName = function filterByName(files) {
	  var f = [];
	...
	var folderIndexSuccess = function folderIndexSuccess(response) {
	  $('.folder-list').empty();
	  var data = filterByName(response.files);
	  var showFoldersHtml = foldersTemplate({ files: data });
	  $('.folder-list').append(showFoldersHtml);
	  $('.open-folder').on('click', openFolder);
	};

	var folderIndexFailure = function folderIndexFailure(error) {
	...
	// file index
	var filterByFolder = function filterByFolder(files) {
	  return files.filter(function (file) {
	    return file.folder === store.folder;
	  });
	};

	var openFolderTable = function openFolderTable() {
	  $('.folder-list-container').toggle('display');
	  $('.files-list-container').toggle('display');
	  $('#add-file').trigger('reset');
	};

	var openAddModal = function openAddModal(event) {
	...
	var highlightRows = function highlightRows() {
	  $('.tag').each(function (i) {
	...
	var fileIndexSuccess = function fileIndexSuccess(response) {
	  $('.file-list').empty();
	  var data = filterByFolder(response.files);
	  var showFilesHtml = filesTemplate({ files: data });
	...
	var fileIndexFailure = function fileIndexFailure(error) {
	  displayError('File Index', error);
	};

	// add file
	var addFileSuccess = function addFileSuccess(response) {
	...
	var addFileFailure = function addFileFailure(error) {
	...
	// update file
	var updateFileSuccess = function updateFileSuccess(response) {
	  $('.file-update-modal').modal('toggle');
	  reloadFileList();
	};
	var updateFileFailure = function updateFileFailure(error) {
	  displayError('Please check that you are the owner of this file. Update file', error);
	  $('.file-update-modal').modal('toggle');
	};

	// delete file
	var openDeleteModal = function openDeleteModal(event) {
	  store.fileId = $(event.target).parent().data('id');
	};

	var deleteFileSuccess = function deleteFileSuccess(response) {
	  $('.file-delete-modal').modal('toggle');
	  reloadFileList();
	};
	var deleteFileFailure = function deleteFileFailure(error) {
	  displayError('Please check that you are the owner of this file. Delete File', error);
	  $('.file-delete-modal').modal('toggle');
	};

	var displayError = function displayError(methodNameText, error) {
	...
	module.exports = {
	  fileIndexSuccess: fileIndexSuccess,
	  fileIndexFailure: fileIndexFailure,
	  folderIndexSuccess: folderIndexSuccess,
	  folderIndexFailure: folderIndexFailure,
	  addFileSuccess: addFileSuccess,
	  addFileFailure: addFileFailure,
	  ...
	  openFolderTable: openFolderTable
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr>\n  <td class=\"col-xs-2\" align=\"center\" data-id=\"\">\n    <a class=\"btn btn-default open-folder\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.folder : stack1), depth0))
	    + "\"><em class=\"fa fa-folder-open-o \" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.folder : stack1), depth0))
	    + "\"></em></a>\n  </td>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.folder : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</tr>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "  <td class=\"col-xs-2\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.folder : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.folder : stack1), depth0))
	    + "</td>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr>\n\n  <td class=\"col-xs-2\" align=\"center\" data-id=\""
	    ...
	    + "\" class=\"btn btn-default open-file-download\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <em class=\"fa fa-download\"></em>\n    </a>\n\n    <a class=\"btn btn-default open-file-edit\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"modal\" data-target=\".file-update-modal\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" data-tag=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tag : stack1), depth0))
	    + "\">\n      <em class=\"fa fa-pencil\"></em>\n    </a>\n\n    <a class=\"btn btn-danger open-file-delete\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"modal\" data-target=\".file-delete-modal\">\n      <em class=\"fa fa-trash\"></em>\n    </a>\n  </td>\n  <td class=\"col-xs-2\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    ...
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.updatedAt : stack1), depth0))
	    + "</td>\n  <td class=\"col-xs-2 tag\" data-type=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tag : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tag : stack1), depth0))
	    + "</td>\n\n</tr>\n";
